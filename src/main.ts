...
async function bootstrap() {
  ...
  logger.warn(`Console v${configService.package.version} is listening on ${startupConfig.host} port ${startupConfig.port}`);
  await app.listen(startupConfig.port, startupConfig.host);
}
bootstrap();
